  ...
  function countyOnClick(county){
    $.ajax({
      ...
      success: function(response) {
        ...
        response.studyarea.forEach(
          (i) =>
            (marker = new L.marker([i[1], i[0]], { icon: StudyAreaIcon })
              .bindPopup(
                `${i[3]}<small style="color: grey">${i[2]}</small>`
              )
              ...
              .on("click", function (e) {
                ...
                $.ajax({
                  ...
                  success: function(response) {
                    ...
                    // 更換右側統計圖
                    $('#map-info').html(`
                      <h1 id="click-county" class="title-light mb-3" style="font-size: 54px">${i[3]}</h1>
                      <h4 class="mb-3" style="color: gray">${i[2]}</h4>
        ...
        $('#map-info').html(
          `<h1 id="click-county" class="title-light mb-3" style="font-size: 54px">${county}</h1>
          <div class="row desp">
